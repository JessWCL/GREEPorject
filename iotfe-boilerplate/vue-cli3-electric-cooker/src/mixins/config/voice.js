  ...
  data() {
    return {
      modeKeyText: [
        ...
        { key: 'brown', value: 18, name: '糙米饭' }, // 糙米饭
      ...
      understandText: [
        ...
        },
        {
          ...
          opt: '["Pow","mode","TmrEn","StTmr","KpTpEn","KpTpTmr"]',
          p: '[1,4,1,90,0,0]',
          msg: '已为您开始烹饪 当前模式为煮粥'
        },
        {
          key: 'control_modebrown',
          opt: '["Pow","mode","TmrEn","StTmr","KpTpEn","KpTpTmr"]',
          p: '[1,18,1,95,0,0]',
          msg: '已为您开始烹饪 当前模式为糙米饭'
        },
        {
          key: 'control_modeyoghurt',
          opt: '["Pow","mode","TmrEn","StTmr","KpTpEn","KpTpTmr"]',
          p: '[1,12,1,480,0,0]',
          msg: '已为您开始烹饪 当前模式为酸奶'
        },
        ...
        },
        {
          ...
          opt: '["Pow","mode","TmrEn","StTmr","StpRic","KpTpEn","KpTpTmr"]',
          p: '[1,10,1,30,0,0,0]',
          msg: '已为您开始烹饪 当前模式为蒸煮'
        },
        {
        ...
        {
          key: 'control_startbrown',
          opt: '["Pow","mode","TmrEn","StTmr","KpTpEn","KpTpTmr"]',
          p: '[1,18,1,95,0,0]',
          msg: '已为您开始烹饪 当前模式为糙米饭'
        },
        {
          key: 'control_startyoghurt',
          opt: '["Pow","mode","TmrEn","StTmr","KpTpEn","KpTpTmr"]',
          p: '[1,12,1,480,0,0]',
          msg: '已为您开始烹饪 当前模式为酸奶'
        },
        ...
        },
        {
          ...
          opt: '["Pow","TmrEn","SchEn","SchTmr","KpTpEn","KpTpTmr"]',
          p: '[0,0,0,0,0,0]',
          msg: '已为您取消预约'
        },
        {
          key: 'control_cancellationrefined',
          opt: '["Pow","mode","TmrEn","StTmr","StpRic","KpTpEn","KpTpTmr"]',
          p: '[0,2,0,60,0,0,0]',
          msg: '已为您取消精煮饭'
        },
        ...
        {
          key: 'control_cancellationbrown',
          opt: '["Pow","mode","TmrEn","StTmr","KpTpEn","KpTpTmr"]',
          p: '[0,18,0,95,0,0]',
          msg: '已为您取消糙米饭'
        },
        {
          key: 'control_cancellationyoghurt',
          opt: '["Pow","mode","TmrEn","StTmr","KpTpEn","KpTpTmr"]',
          p: '[0,12,0,480,0,0]',
          msg: '已为您取消酸奶'
        },
