    ...
    <gree-page no-navbar class="page-home">
      ...
      <div class="page-main">
        ...
        <gree-notice-bar icon v-if="[1, 2, 3].includes(BatteryWarn) && Pow">
          <gree-icon slot="left" name="warning" color="#f20c01" />
      ...
      <!-- 电源关闭 -->
      <gree-power-off v-model="showPowerOff" :text="$language('home.powerOff')" :style="{ backgroundImage:'url(' + power_off_bg + ')' }" />
    </gree-page>
    <!-- 底部弹出层按钮 -->
    <function-list :is-popup-show="isPopupShow" />
    <!-- 底部按钮 -->
