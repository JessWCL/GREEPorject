...
(function() {
  ...
  define('cordova/android/nativeapiprovider', function(
    require,
    exports,
    module
  ) {
  ...
  define('cordova/android/promptbasednativeapi', function(
    require,
    exports,
    module
  ) {
  ...
  define('cordova/exec', function(require, exports, module) {
    ...
    var resolvedPromise =
      typeof Promise == 'undefined' ? null : Promise.resolve();
    ...
    function androidExec(success, fail, service, action, args) {
      ...
      var msgs = nativeApiProvider
        .get()
        .exec(bridgeSecret, service, action, callbackId, argsJson);
      // If argsJson was received by Java as null, try again with the PROMPT bridge mode.
      // This happens in rare circumstances, such as when certain Unicode characters are passed over the bridge on a Galaxy S2.  See CB-2666.
      if (
        jsToNativeBridgeMode == jsToNativeModes.JS_OBJECT &&
        msgs === '@Null arguments.'
      ) {
    ...
    function pollOnce(opt_fromOnlineEvent) {
      ...
      var msgs = nativeApiProvider
        .get()
        .retrieveJsMessages(bridgeSecret, !!opt_fromOnlineEvent);
      if (msgs) {
        messagesFromNative.push(msgs);
    ...
    function processMessage(message) {
      ...
      if (firstChar == 'J') {
        ...
        console.log(
          'processMessage failed: invalid message: ' + JSON.stringify(message)
        );
      }
    }
    ...
    module.exports = {
      ...
      bootstrap: function() {
        ...
        function bindButtonChannel(buttonName) {
          ...
          var volumeButtonChannel = cordova.addDocumentEventHandler(
            buttonName + 'button'
          );
  ...
  define('cordova/plugin/android/app', function(require, exports, module) {
    ...
    var APP_PLUGIN_NAME =
      Number(require('cordova').platformVersion.split('.')[0]) >= 4
        ? 'CoreAndroid'
        : 'App';
