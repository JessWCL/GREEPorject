...
export default {
  ...
  methods: {
    ...
    _touchend(event) {
      ...
      console.log('this.selectId', this.selectId, 'this.selectOrderId', this.selectOrderId, 'selectIdTmp', selectIdTmp);
      //  向父组件传出事件：
    ...
    setId(id) {
      ...
      console.log('setId--->id', id, 'selectId', this.selectId, 'selectOrderId', this.selectOrderId, 'carousel.rotation', this.carousel.rotation);
      this.carousel.transform();
