      ...
      if (!state.functype && p.length !== 0) {
        ...
        _timer2 = setTimeout(async () => {
          ...
          try {
            ...
            //   state.dataObject.DwatSen,
            //   state.dataObject.Dmod,
            //   state.dataObject.WdSpd,
            //   state.dataObject.Dfltr,
            //   state.dataObject.DwatFul,
            ...
            const _p = [
              ...
              state.deviceInfo.name,
              state.dataObject.TemSen,
              state.dataObject.estateInsta21,
              state.dataObject.estateOutsta22,
              state.dataObject.estateOutsta23,
              state.dataObject.estateOutsta24,
              state.dataObject.DwatFul
            ];
            // 成功之后更新主体状态
