...
function parseData(data) {
  ...
  DataObject.Lig = parseInt(obj[11], 10);
  DataObject.MidType = parseInt(obj[12], 10);
  DataObject.estateInsta21 = parseInt(obj[13], 10);
  DataObject.estateOutsta22 = parseInt(obj[14], 10);
  DataObject.estateOutsta24 = parseInt(obj[15], 10);
  DataObject.estateOutsta23 = parseInt(obj[16], 10);
  return DataObject;
}
