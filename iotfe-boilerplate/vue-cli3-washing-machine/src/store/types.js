 ...
 * @LastEditTime: 2020-07-09 11:08:06
 */
/** mutations */
/* *******************请勿修改***************start************ */
...
export const SET_PARSE_OBJECT = 'SET_PARSE_OBJECT'; // 解析的dataObj过渡态
export const SET_PARSE_DATAOBJECT = 'SET_PARSE_DATAOBJECT'; // 解析查询的dataObj过渡态
export const SET_UPPER_OBJECT = 'SET_UPPER_OBJECT'; // set上层数据态
export const SET_MIDDLE_OBJECT = 'SET_MIDDLE_OBJECT'; // set中层数据态
export const SET_LOW_OBJECT = 'SET_LOW_OBJECT'; // set下层数据态
...
export const GET_POW_ON_STATES = 'GET_POW_ON_STATES'; // 开机获取一包数据
