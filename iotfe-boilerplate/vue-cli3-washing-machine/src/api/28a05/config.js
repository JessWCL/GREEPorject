...
const washList28a05 = [
  ...
  // 快洗 2
  {
    ...
    configList: [
      ...
      {
        list: ['不烘干', '标准', '超干', 30, 60, 90, 120, 150],
        protocol: 'dry', // 协议字段 转速
        timeList: {
          0: 0,
          1: 58,
...
const modeIndexList28a05 = {};
washList28a05.forEach((element, index) => {
  modeIndexList28a05[element.modeNum] = index;
});


// 配置参数进入洗涤程序某些阶段后（含该阶段）不可再选
const disabledConfigObj28a05 = {
  setWashTime: 37, // 洗涤时间
  washTemp: 43, // 洗涤温度
  potch: 70, // 漂洗次数
  speed: { // 转速
...
export {modeIndexList28a05, washList28a05, disabledConfigObj28a05, disabledFunObj28a05};
