...
// modeIndexList28a02: [2, 3, 1, 4, 10, 11, 16, 8, 6, 7, 29, 30, 5, 29, 24],
// 洗涤模式字段 对应 washList 中的数组下标.（如 1 表示 洗涤模式字段为1的模式 匹配 washList数组中第2位） 
const modeIndexList28a02 = {};
washList28a02.forEach((element, index) => {
  modeIndexList28a02[element.modeNum] = index;
});


// 配置参数进入洗涤程序某些阶段后（含该阶段）不可再选
const disabledConfigObj28a02 = {
  setWashTime: 37, // 洗涤时间
  washTemp: 43, // 洗涤温度
  potch: 70, // 漂洗次数
  speed: { // 转速
    value: 88,
    diableList: [34, 67, 83, 44, 60]
  }
};

// 高级功能进入洗涤程序某些阶段后（含该阶段）不可再选
const disabledFunObj28a02 = {
  energySave: 37, // 节能
  autoScour: 37, // 洗涤剂
  soak: 42, // 浸泡
  highWater: 84, // 高水位
  ...
  nightWash: { // 夜间洗
    value: 88, 
    diableList: [34, 67, 83, 44, 60, 123], // 中间脱水的小阶段
  }, // 夜间洗
};

export {modeIndexList28a02, washList28a02, disabledConfigObj28a02, disabledFunObj28a02};
