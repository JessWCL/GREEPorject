...
export default {
  ...
  computed: {
    ...mapState({
      ...
      JFerr: state => state.parseObj.drum1Params.JFerr,
      
      mute: state => state.parseObj.drum1Params.mute,
  ...
  methods: {
    ...
    handlePause() {
      ...
      if (!this.isDisable) {
        ...
        this.setUpperObj(Object.assign(obj2, obj));
        this.isDisable = true;
        this.sendCtrl(obj);
    ...
    setFunction(type, index, item) {
      ...
      if (protocol === 'Pow') {
        if (!this.isCloseing) {
          ...
          this.setUpperObj(Object.assign(commitObj, obj));
          // this.sendCtrl(obj);
          return;
        } 
