...
function parseData(data) {
  ...
  DataObject.Mod = parseInt(obj[2], 10);
  DataObject.WdSpd = parseInt(obj[3], 10);
  DataObject.TmrOn = parseInt(obj[4], 10);
  DataObject.TmrAction = parseInt(obj[5], 10);
  DataObject.TmrHour = parseInt(obj[6], 10);
  DataObject.TmrMin = parseInt(obj[7], 10);
  DataObject.estate2 = parseInt(obj[8], 10);
