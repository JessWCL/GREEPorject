 ...
 * @param {Function} callback mqtt 回调
 */
...
export const getHelpDocs = (topNum) => {
  return new Promise((resolve, reject) => {
    try {
      navigator.PluginInterface.getHelpDocs(topNum, (...args) => {
        console.log(args);
        resolve(args);
      });
    } catch (err) {
...
export const webShareUrlGeneral = (url, title, brief) => {
  return new Promise((resolve, reject) => {
    try {
      navigator.PluginInterface.webShareUrlGeneral(url, title, brief, (...args) => {
        resolve(...args);
      });
    } catch (error) {
      reject(error);
...
export const loadUrl = (url) => {
  return new Promise((resolve, reject) => {
    try {
      navigator.PluginInterface.loadUrl(url);
    } catch (error) {
      reject(error);
    }
  });
 ...
 * 设置设备自定义数据接口
 * @param {string} mac    
 * @param {string} subMac 子mac 没有则为 ''
 * @param {string} type   
 * @param {string} value
 */
export const SetDevCustomData = (mac, subMac, type, value) => {
  return new Promise((resolve, reject) => {
    try {
      navigator.PluginInterface.SetDevCustomData(mac, subMac, type, value, (...params) => {
        resolve(...params)
      });
    } catch (error) {
      reject(error);
 ...
 * @param {string} type   
 */
export const GetDevCustomData = (mac, subMac, type) => {
  return new Promise((resolve, reject) => {
    try {
      navigator.PluginInterface.GetDevCustomData(mac, subMac, type, (...params) => {
        resolve(...params)
      });
    } catch (error) {
      reject(error);
...
export const deleteCloudTimer = timerIDs => {
  return new Promise((resolve, reject) => {
    try {
      navigator
        .PluginInterface
        .deleteCloudTimer(timerIDs, (...params) => {
          resolve(...params);
        });
...
export const setCloudTimer = (timerDic, taskDic) => {
  return new Promise((resolve, reject) => {
    try {
      navigator.PluginInterface.setCloudTimer(
        timerDic,
        taskDic,
        (...params) => {
          resolve(...params);
...
export const modifyCloudTimer = (timerDic, taskDic, timerID) => {
  return new Promise((resolve, reject) => {
    try {
      navigator.PluginInterface.modifyCloudTimer(
        timerDic,
        taskDic,
        timerID,
        (...params) => {
...
export const getCloudTimerInfo = timerID => {
  return new Promise((resolve, reject) => {
    try {
      navigator
        .PluginInterface
        .getCloudTimerInfo(timerID, (...params) => {
          resolve(...params);
        });
    } catch (err) {
      reject(err);
