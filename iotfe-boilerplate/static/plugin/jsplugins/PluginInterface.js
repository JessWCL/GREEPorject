...
cordova.define('com.gree.codovaplugin.PluginInterface', function (require, exports, module) {
    ...
    module.exports = {
        ...
        // 添加自定义云定时
        setCloudTimer: function (timerDic, taskDic, callback) {
          exec(callback, null, 'PluginInterface', 'setCloudTimer', [timerDic, taskDic]);
        },
        // 删除自定义云定时
        deleteCloudTimer: function (timerIDs, callback) {
          exec(callback, null, 'PluginInterface', 'deleteCloudTimer', [timerIDs]);
        },
        // 修改自定义云定时
        modifyCloudTimer: function (timerDic, taskDic, timerID, callback) {
          exec(callback, null, 'PluginInterface', 'modifyCloudTimer', [timerDic, taskDic, timerID]);
        },
        // 查询定义云定时 
        getCloudTimerInfo: function (mac) {
          exec(callback, null, 'PluginInterface', 'getCloudTimerInfo', [mac]);
        },
        /* ======== 总部展厅 五大系统 start ======== */
        ...
        /* ======== 研究性项目 end ======== */
         /* ======== 帮助文档相关接口 start ======== */
        getHelpDocs: function(topNum,callback) { //获取帮助页内容
            exec(callback, null, "PluginInterface", "getHelpDocs", [topNum]);
        },
        webShareUrlGeneral: function (shareUrl, shareTitle, shareText) { //分享URL
            exec(null, null, "PluginInterface", "webShareUrlGeneral", [shareUrl, shareTitle, shareText]);
        },
        loadUrl: function (shareUrl) { //刷新
            exec(null, null, "PluginInterface", "loadUrl", [shareUrl]);
        },
        /* ======== 帮助文档相关接口 end ======== */
    };
});