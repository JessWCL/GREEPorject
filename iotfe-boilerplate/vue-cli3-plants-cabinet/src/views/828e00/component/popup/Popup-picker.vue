        ...
        >
          ...
          >
            ...
            <div class="picker-box double-picker" v-if="modeConfig.type === 'double'">
              <doublePicker ref="doublePickerContainer" :mode="mode"></doublePicker>
            </div>
          </div>
...
import doublePicker from "./Double-picker.vue";
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.modeConfig.type === 'single') {
        ...
        const doublePickerContainer = this.$refs.doublePickerContainer;
        const mode = this.mode;
        // console.log(doublePickerContainer.double_picker1.getColumnValues());
        const picker1Data = doublePickerContainer.double_picker1.getColumnValues();
        const picker2Data = doublePickerContainer.double_picker2.getColumnValues();
        const onH = picker1Data[0].value;
        const onM = picker1Data[1].value;
        const offH = picker2Data[0].value;
        const offM = picker2Data[1].value;
        console.log('Popup-picker >submit >doublePicker: ', mode, onH, onM, offH, offM);
        let sendVal = {};
        switch (mode) {
          case 'Light':
            sendVal = {};
            sendVal.LigOnH = onH;
            sendVal.LigOnM = onM;
            sendVal.LigOffH = offH;
            sendVal.LigOffM = offM;
            this.setDataObject(sendVal);
            this.sendCtrl(sendVal);
            break;
          case 'Wind':
            sendVal = {};
            sendVal.WindOnH = onH;
            sendVal.WindOnM = onM;
            sendVal.WindOffH = offH;
            sendVal.WindOffM = offM;
            this.setDataObject(sendVal);
            this.sendCtrl(sendVal);
            break;
          case 'WatPump':
            ...
            sendVal.WatOnH = onH;
            sendVal.WatOnM = onM;
            sendVal.WatOffH = offH;
            sendVal.WatOffM = offM;
            this.setDataObject(sendVal);
            this.sendCtrl(sendVal);
            break;
          default :
