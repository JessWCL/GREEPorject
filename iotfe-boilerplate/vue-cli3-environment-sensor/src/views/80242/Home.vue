    ...
    >
      ...
      <div class="page-main">
        ...
        <gree-notice-bar
          ...
          v-if="!isWarningShow && Pow && SensorErr && !isMultiError"
        >
          <img
            slot="left"
        ...
        <gree-notice-bar
          @click.native="$router.push({ name: 'Error' })"
          v-else-if="!isWarningShow && Pow && SensorErr && isMultiError"
        >
          <img
            slot="left"
            src="@/assets/img/warning.png"
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      deviceNum: state => state.deviceNum.num
    }),
    head_bg() {
      let bg;
