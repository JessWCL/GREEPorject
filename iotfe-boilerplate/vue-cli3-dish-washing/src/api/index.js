...
} else if (MID === DW_MID_828902) {
  funBtnList = require('./828902/funBtnList').default;
  modeBtnList = require('./828902/modeBtnList').default;
  menuBtnList = require('./828902/menuBtnList').default;
  // errorObjects = require('./828901/errorObjects').default;
  errorObjects = require('./828902/newErrorObjects').default;
}
