...
const ErrObj1 = [
  ...
  { id: 2, code: 'E3', headtitle: '故障名称：', title: '感温包故障', subtitle: '解除办法：', text: '请通知售后人员维修', reason: '感温包开短路', errorCode: 'E3', resolve: '请通知售后人员维修' },
  ...
  { id: 7, code: 'H0', headtitle: '故障名称：', title: '板间通讯故障', subtitle: '解除办法：', text: '请通知售后人员维修', reason: '显示板与主板间通讯异常', errorCode: 'H0', resolve: '请通知售后人员维修' },
  { id: 8, code: 'F5', headtitle: '故障名称：', title: '加热器故障', subtitle: '解除办法：', text: '请通知售后人员维修', reason: '不加热', errorCode: 'F5', resolve: '请通知售后人员维修' },
];
const ErrObj2 = [
  { id: 1, code: '!', headtitle: '故障名称：', title: '门未关闭', subtitle: '解除办法：', text: '请关好门', reason: '运行过程中门未闭合好', errorCode: null, resolve: '请关好门' },
  { id: 2, code: 'F6', headtitle: '故障名称：', title: '进水故障', subtitle: '解除办法：', text: '请打开水龙头', reason: '进水异常，进不够水', errorCode: null, resolve: '请通知售后人员维修' },
  { id: 3, code: '!', headtitle: '故障名称：', title: '缺漂洗剂', subtitle: '解除办法：', text: '请添加漂洗剂', reason: '漂洗剂不足', errorCode: null, resolve: '请添加漂洗剂' },
  { id: 4, code: '!', headtitle: '故障名称：', title: '缺专用盐', subtitle: '解除办法：', text: '请添加洗碗机专用盐', reason: '洗碗机专用盐不足', errorCode: null, resolve: '请添加洗碗机专用盐' },
  { id: 5, code: 'H8', headtitle: '故障名称：', title: '触摸按键故障', subtitle: '解除办法：', text: '请通知售后人员维修', reason: '主芯片与触摸芯片通讯异常', errorCode: 'H8', resolve: '请通知售后人员维修' },
];
const ErrObj3 = [
