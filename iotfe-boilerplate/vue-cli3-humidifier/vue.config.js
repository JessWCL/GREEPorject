...
if (process.env.VUE_APP_MID === '828501') {
  copyOptions.push({
    from: path.resolve(__dirname,  `./src/assets/${process.env.VUE_APP_MID}/images/`),
    to: path.resolve(
      __dirname,
      `./dist/plugins/Plugins/${process.env.VUE_APP_MID}/images/`
    )
  },
  {
