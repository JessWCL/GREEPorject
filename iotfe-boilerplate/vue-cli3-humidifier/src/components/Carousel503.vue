        ...
        >
          ...
          >
            <div
              ...
              :class="{'light-label': itemlight1 === true&&item.content !== '智能',
                       'black-label': itemlight1 === false&&item.content !== '智能',
                       'custom-figure-style': item.content === '智能'&&itemlight1 === true,
                       'custom-figure-style1': item.content === '智能'&&itemlight1 === false}"
            >
              {{ item.content }}
              <span
...
export default {
  ...
  methods: {
    ...
    adjustRotation(execTransform) {
      let remainder = this.carousel.rotation % this.carousel.theta;
      if (remainder) {
        let quotient = parseInt(this.carousel.rotation / this.carousel.theta, 10);
        this.carousel.rotation = quotient * this.carousel.theta;
        if (execTransform) {
          this.carousel.transform();
        }
      }
