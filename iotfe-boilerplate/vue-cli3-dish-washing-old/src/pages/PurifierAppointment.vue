<template>
  <div class="purifier-container">
    ...
    <!-- header end -->
    <div class="purifier-tips">保洁有防潮防霉除异味功能，在运行干燥后开启</div>
    <mt-picker
...
export default {
  ...
  methods: {
    ...mapMutations('device', ['setBtnStatus']),
    ...mapMutations('device', ['setPurifier']),
    ...mapMutations('device', ['setPurifierTime']),
    ...
    handleRightClick() {
      ...
      this.setBtnStatus({ id: this.$store.state.device.FUN_BTNS.PURIFIER, isActive: true });
      this.parseBarColor();
    },
