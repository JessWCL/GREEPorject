...
import { BtnClassName } from '../constants';
...
const _funBtnList = [
  ...
  },
  {
    ...
    isForbided: false, // 是否禁用
    btnClassName: BtnClassName.blue,
    normalIconSrc: iconAntiBacterialWashNormal, // 普通图标 // ** 实际为消毒**
    activeIconSrc: iconAntiBacterialWashActive, // 激活图标 // ** 实际为消毒**
    forbidedIconSrc: iconAntiBacterialWashForbided, // 禁用图标 // ** 实际为消毒**
    txtActiveIcon: '', // 激活图标 提示语
  },
];
