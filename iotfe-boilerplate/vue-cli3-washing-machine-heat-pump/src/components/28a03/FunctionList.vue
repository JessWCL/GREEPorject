 ...
 * @LastEditTime: 2020-05-12 11:36:02
 -->
<template>
...
import funcConfig from '../../mixins/config/28a03/funcConfig';
...
export default {
  ...
  methods: {
    ...
    handleSelect(newV, oldV, protocol) {
      ...
      const time = this.washList[this.washModeIndex].auxiliaryTimeList[protocol];
