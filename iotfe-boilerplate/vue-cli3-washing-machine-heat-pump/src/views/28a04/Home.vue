          ...
          <div class="data-list-div">
            ...
            <div :class="washList[modeIndexList[washMode]].configList.length > 4 && howPage === 1 ? 'data-list-arrow' : 'data-list'">
              ...
              >
                ...
                ></div>
                <p class="protocol-value" :class="{'visibility-hidden' : isActive && index === clickConfigIndex}" @click="toggle(index)" ref="trigger">{{ valueChangeZn(dataObject[item.protocol], item.protocol) }} <span class="protocol-unit" :class="{'hidden': !dataObject[item.protocol]}"> {{ washUnit[item.protocol] }}</span></p>
