const modeList = [
  ...
  },
  {
    ...
    */
    ...
    hasTextre: false, // 是否口感选择
    defaultTimeForCustomize: [], // 根据米种口感自定义时间
    ImgUrl: require('../assets/img/new_btn_coarsecerealporridge.png'),
    selectImgUrl: require('../assets/img/new_btn_coarsecerealporridge_select.png'),
    carouselImgUrl: require('../assets/img/new_icon_coarsecerealporridge_index.png'), // 杂粮粥
  },
  {
    index: 6, // 在该数组中的下标
    modeId: 6, // 与整机模式对应
